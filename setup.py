...
def get_long_description():
    ...
    try:
        ...
        return github2pypi.replace_url(
            slug="mberkay0/labelme", content=long_description, branch="main"
        )
    except ImportError:
...
def main():
    ...
    setup(
        ...
        description="Semi-Auto Annotation Tool Labelme",
        long_description=get_long_description(),
        long_description_content_type="text/markdown",
        author="Berkay Mayali",
        author_email="berkaymyl@gmail.com",
        url="https://github.com/mberkay0/automated-labelme",
        install_requires=get_install_requires(),
        license="GPLv3",
        keywords="Image Annotation, Machine Learning, Deep Learning, CNN, MaskRCNN",
        classifiers=[
